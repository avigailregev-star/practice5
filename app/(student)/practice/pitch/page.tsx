...
import PitchAssessment from "@/components/student/PitchAssessment";
...
export default async function PitchPage() {
  ...
  return (
    <main className="max-w-sm mx-auto bg-brand-bg min-h-screen">
      {/* Header */}
      <div className="bg-gradient-to-br from-teal-500 to-purple-600 px-5 pt-10 pb-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-extrabold text-white">בדיקת גובה צליל</h1>
        </div>
      </div>

      <PitchAssessment studentId={user.id} initialLevel={initialLevel} />
    </main>
  );
}
